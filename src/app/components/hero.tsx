...
export default function Hero() {
  ...
  <div className="container mx-auto flex px-5 py-18 items-center justify-center flex-col">
    <Image
      className="lg:w-3/6 md:w-3/6 w-5/6 mb-10 border-4 border-blue-500 object-cover object-center rounded-[50px]"
      alt="hero"
      src={img}
    />
    <div className="text-center lg:w-2/3 w-full">
    <div className="p-4">
  <h1 className="text-4xl font-bold mb-4">Exploring Next.js 15 RC</h1>
  ...
  <p className="text-2xl">
    ...
    <div className="p-4">
  <h1 className="text-4xl font-bold mb-4">Stable improvements</h1>
  ...
  <h1 className="text-4xl font-bold mb-4">What is Next.js?</h1>
  <p className="text-2xl mb-6">
  ...
  <h1 className="text-4xl font-bold mb-4">How do I upgrade to the latest Next.js version?</h1>
  <p className="text-2xl mb-6">
    To upgrade to the latest version of Next.js (version 15 RC), use the following command with your preferred package manager:
  </p>
  
  <h2 className="text-3xl font-semibold mb-2">NPM</h2>
  <code className="block text-2xl bg-gray-100 p-2 rounded">npm i next@rc react@rc react-dom@rc eslint-config-next@rc</code>
  
  <h2 className="text-3xl font-semibold mt-4 mb-2">Yarn</h2>
  <code className="block text-2xl bg-gray-100 p-2 rounded">yarn add next@rc react@rc react-dom@rc eslint-config-next@rc</code>
  ...
  <h1 className="text-4xl font-bold mb-4">React 19 RC</h1>
  <p className="text-2xl mb-6">
...
<div className="p-4">
  <h1 className="text-4xl font-bold mb-4">React Compiler</h1>
  <p className="text-2xl mb-6">
  ...
  <code className="block text-2xl bg-gray-100 p-2 rounded mb-6">npm install babel-plugin-react-compiler</code>
...
module.exports = nextConfig;`}
  ...
  <h2 className="text-4xl font-bold mb-4">Key benefits of the React Compiler</h2>
  <ul className="text-2xl mb-6">
  ...
  <p className="text-2xl">
    <strong>Note:</strong> The React Compiler is currently in an experimental phase, and its features and capabilities may evolve. It’s recommended that you stay updated with the latest developments and consider using it cautiously in your projects.
  </p>
</div>

<div className="p-4">
  <h1 className="text-4xl font-bold mb-4">Hydration error enhancements</h1>
  <p className="text-2xl mb-6">
  ...
  <h1 className="text-4xl font-bold mb-4">Caching updates</h1>
  <p className="text-2xl mb-6">
  ...
  <h2 className="text-3xl font-semibold mb-2">Client-side navigation cache</h2>
  <p className="text-2xl mb-6">
    When navigating between pages using <code>&lt;Link&gt;</code> or <code>useRouter</code>, the client-side router no longer caches page segments. However, these segments are still reused during browser back and forward navigation, as well as for shared layouts. To enable caching for specific page segments, you can use the <code>staleTimes</code> configuration option.
  </p>

  <h2 className="text-3xl font-semibold mb-2">fetch Requests</h2>
  <p className="text-2xl mb-6">
    In Next.js 15, fetch requests are no longer cached by default. Previously, <code>force-cache</code> was the default unless a dynamic function or dynamic config option was used.
  </p>
  
  <code className="block text-2xl bg-gray-100 p-2 rounded mb-6">
    fetch(&apos;https://...&apos;, &#123; cache: &apos;force-cache&apos; | &apos;no-store&apos; &#125;);
  </code>

  <p className="text-2xl mb-6">
    Next.js uses the Web fetch API cache option to define how a server-side fetch request interacts with the framework’s persistent HTTP cache. The <code>no-store</code> option fetches a resource from a remote server on every request and does not update the cache. The <code>force-cache</code> option fetches a resource from the cache if it exists, or a remote server and updates the cache.
  </p>

  <p className="text-2xl">
    To enable caching for fetch requests, you can:
  </p>
  <ul className="text-2xl mb-6 list-disc list-inside">
    <li>Use the <code>cache</code> option <code>force-cache</code> for a specific fetch call.</li>
    <li>Use <code>force-static</code> for a dynamic route’s config.</li>
    <li>Set the <code>fetchCache</code> route config to <code>default-cache</code> to apply <code>force-cache</code> globally on a page or layout, except for fetch calls with a different cache setting.</li>
  </ul>
</div>

<div className="p-4">
  <h1 className="text-4xl font-bold mb-4">GET route handlers</h1>
  <p className="text-2xl mb-6">
  ...
  <p className="text-2xl mb-6">
    Special Route Handlers such as <code>sitemap.ts</code> and other metadata files are static by default unless they use dynamic functions or dynamic config options.
  </p>

  <h1 className="text-4xl font-bold mb-4">Client router cache behavior in Next.js 15</h1>
  <p className="text-2xl mb-6">
  ...
  <code className="block text-2xl bg-gray-100 p-2 rounded">
    const nextConfig = &#123;<br />
    &nbsp;&nbsp;experimental: &#123;<br />
...
<div className="p-4">
  <h1 className="text-4xl font-bold mb-4">Create-next-app enhancements</h1>
  <p className="text-2xl mb-6">
    Let’s discuss the improvements in <code>create-next-app</code>. When you launch the app, it now has a new landing page and provides a prompt for choosing Turbopack when creating the Next app.
  </p>
...
<div className="p-4">
  <h1 className="text-4xl font-bold mb-4">Improving the bundling of external libraries (stable)</h1>
  <p className="text-2xl mb-6">
  ...
  <p className="text-2xl mb-6">
    To streamline configurations across both the App and Pages routers, a new option named <code>bundlePagesRouterDependencies</code> was introduced. This setting will align with the App Router’s default behavior of automatically bundling external libraries. The <code>serverExternalPackages</code> option remains available to exclude specific libraries as needed.
  </p>
</div>

<div className="p-4">
  <h1 className="text-4xl font-bold mb-4">Response execution with next/after (experimental)</h1>
  <p className="text-2xl mb-6">
...
<div className="p-4">
  <h1 className="text-4xl font-bold mb-4">Partial Prerendering</h1>
  <p className="text-2xl mb-6">
