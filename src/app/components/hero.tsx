            ...
            <div className="container mx-auto flex flex-col items-center px-5 py-10 md:py-20">
                ...
                <div className="text-center lg:w-2/3 w-full">
                    ...
                    <div className="p-4">
                        ...
                        <code className="block text-lg md:text-2xl bg-gray-100 p-2 rounded mb-6">npm install babel-plugin-react-compiler</code>
...
module.exports = nextConfig;`}
 ...
 The <code>–turbo</code> flag can be used to activate Turbopack.
                    ...
                    <div className="p-4">
                        ...
                        <p className="text-lg md:text-2xl mb-6">
                            To facilitate incremental adoption, we have added an <code>experimental_ppr</code> route config option to enable PPR for specific Layouts and Pages. Refer to the following code example.
                        </p>
